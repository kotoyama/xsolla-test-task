...
Для локальной работы необходимо создать файлик `.env` и подставить туда свой конфиг постгреса, все необходимые переменные окружения можно найти [тут](src/config/typeorm.config.ts).
